...
function definition () {
   ...
   // $mform->addElement('select', 'tomagrade_DefaultShareTomax', get_string('tomagrade_DefaultShareTomax', 'plagiarism_tomagrade'), $showstudentsopt);
    ...
    $mform->addElement('select', 'tomagrade_DefaultIdentifier_TEACHER', get_string('tomagrade_DefaultIdentifier_TEACHER', 'plagiarism_tomagrade'), $identifierarray_TEACHER);
